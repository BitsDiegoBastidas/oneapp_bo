...
class DataBalanceDetailRestLogicBo extends DataBalanceDetailRestLogic {
  ...
  public function getWebcomponentConfiguration() {
    $configs = [];
    $this->configBlock["detail"]["webcomponent"]["supportedVersions"]["min"] =
      empty($this->configBlock["detail"]["webcomponent"]["supportedVersions"]["min"])
      ? '1.0.0'
      : $this->configBlock["detail"]["webcomponent"]["supportedVersions"]["min"];
    $this->configBlock["detail"]["webcomponent"]["supportedVersions"]["max"] =
      empty($this->configBlock["detail"]["webcomponent"]["supportedVersions"]["max"])
      ? NULL
      : $this->configBlock["detail"]["webcomponent"]["supportedVersions"]["max"];
    $this->configBlock["detail"]["webcomponent"]["show"] = !empty($this->configBlock["detail"]["webcomponent"]["show"]);
