...
class BillingServiceBo extends BillingService {
  ...
  /**
   * Get Call Usage Detail
   */
  public function callUsageDetail($msisdn, $sequenceNumber, $param_url) {
    return $this->manager
      ->load('oneapp_mobile_billing_v2_0_usage_endpoint')
      ->setParams(['msisdn' => $msisdn, 'usage_type'=> $param_url])
      ->setHeaders([])
      ->setQuery([
