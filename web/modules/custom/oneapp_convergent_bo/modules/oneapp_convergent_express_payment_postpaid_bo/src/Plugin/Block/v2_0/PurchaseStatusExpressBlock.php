 ...
 *
 * @Block(
 *  id = "oneapp_convergent_express_payment_postpaid_qr_v2_0_purchase_status_block",
 *  admin_label = @Translation("OneApp Convergent Express Payment Qr Purchase Status v2.0 - (Estado de transacción)"),
 *  group = "oneapp_convergent_payment_gateway_qr"
 * )
 */
class PurchaseStatusExpressBlock extends BlockBase {
