 ...
 *   block_id = "oneapp_convergent_express_payment_postpaid_bo_v2_0_verification_qr_block",
 *   id = "oneapp_convergent_express_payment_postpaid_bo_v2_0_verification_qr_rest_resource",
 *   label = @Translation("OneApp Convergent Express Payment BO - Verification qr"),
 *   uri_paths = {
 *     "canonical" = "/api/v2.0/express/postpaid/{business_unit}/{type}/{id}/verification/qr"
 *   },
 *   anonymous_token = TRUE
 * )
 */
class VerificationQrRestResource extends ResourceBase {
  ...
  public function setService() {
    $this->service = \Drupal::service('oneapp_convergent_express_payment_postpaid_bo.v2_0.verification_qr_rest_logic');
