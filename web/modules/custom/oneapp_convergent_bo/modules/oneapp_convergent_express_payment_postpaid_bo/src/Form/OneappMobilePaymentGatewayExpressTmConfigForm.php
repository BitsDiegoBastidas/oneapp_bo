...
use Drupal\oneapp_convergent_payment_gateway_tm_invoices\Form\OneappMobilePaymentGatewayTmConfigForm;

/**
 * Add the billing form section to the tigo money config form.
 */
class OneappMobilePaymentGatewayExpressTmConfigForm extends OneappMobilePaymentGatewayTmConfigForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('oneapp.payment_gateway_tigomoney.mobile_invoices.config');
    /*
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('oneapp.payment_gateway_tigomoney.mobile_invoices.config')
